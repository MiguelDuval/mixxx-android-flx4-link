...
PioneerDDJFLX4.smartCfxPressed = function(_channel, _control, value) {
    ...
    if (shifted) {
        ...
        if (PioneerDDJFLX4.smartCfxEnabled) { PioneerDDJFLX4.cycleSmartCfxPreset(); }
        else { PioneerDDJFLX4.restoreSmartCfxFilter(); }
    }
    PioneerDDJFLX4.updateSmartCfxLight();
};
...
PioneerDDJFLX4.clearPadFxDeck = function(deckIndex) {
    ...
    slots.forEach(function(slotState) {
        if (slotState) {
            PioneerDDJFLX4.padFxLight(deckIndex, slotState.pad, false, slotState.mode);
        }
    });
...
PioneerDDJFLX4.padFxLight = function(deckIndex, pad, active, mode) {
